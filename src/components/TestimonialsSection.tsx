  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "خدمة ممتازة جداً! الممرضة كانت محترفة ولطيفة مع والدي. شعرنا بالراحة والأمان. أنصح الجميع بمكتب الهدي.",
    ...
    },
    {
      ...
      rating: 5,
      text: "فريق مكتب الهدي ساعدني كثيراً في إدارة مرض السكري. الممرضة تأتي في الوقت المحدد وتتابع حالتي بعناية فائقة.",
    ...
    },
    {
      ...
      rating: 5,
      text: "بعد عمليتي الجراحية، كنت بحاجة لرعاية خاصة. فريق مكتب الهدي قدم لي أفضل رعاية في منزلي. شكراً لكم.",
    ...
    },
    {
      ...
      rating: 5,
      text: "ابنتي كانت تحتاج حقن يومية، وفريق مكتب الهدي جعل الأمر سهلاً علينا. خدمة احترافية ومواعيد دقيقة.",
    ...
    },
    {
      ...
      rating: 5,
      text: "المتابعة المستمرة من فريق مكتب الهدي ساعدتني في السيطرة على ضغط الدم. فريق محترف وودود.",
