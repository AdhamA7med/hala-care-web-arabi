  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "خدمة ممتازة جداً! الممرضة كانت محترفة ولطيفة مع والدي. شعرنا بالراحة والأمان. أنصح الجميع بمكتب نيرس لاين.",
    ...
    },
    {
      ...
      rating: 5,
      text: "فريق مكتب نيرس لاين ساعدني كثيراً في إدارة مرض السكري. الممرضة تأتي في الوقت المحدد وتتابع حالتي بعناية فائقة.",
    ...
    },
    {
      ...
      rating: 5,
      text: "بعد عمليتي الجراحية، كنت بحاجة لرعاية خاصة. فريق مكتب نيرس لاين قدم لي أفضل رعاية في منزلي. شكراً لكم.",
    ...
    },
    {
      ...
      rating: 5,
      text: "ابنتي كانت تحتاج حقن يومية، وفريق مكتب نيرس لاين جعل الأمر سهلاً علينا. خدمة احترافية ومواعيد دقيقة.",
