  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "خدمة ممتازة جداً! الممرضة كانت محترفة ولطيفة مع والدي. شعرنا بالراحة والأمان. أنصح الجميع بهلا كير.",
    ...
    },
    {
      ...
      rating: 5,
      text: "فريق هلا كير ساعدني كثيراً في إدارة مرض السكري. الممرضة تأتي في الوقت المحدد وتتابع حالتي بعناية فائقة.",
    ...
    },
    {
      ...
      rating: 5,
      text: "بعد عمليتي الجراحية، كنت بحاجة لرعاية خاصة. فريق هلا كير قدم لي أفضل رعاية في منزلي. شكراً لكم.",
    ...
    },
    {
      ...
      rating: 5,
      text: "ابنتي كانت تحتاج حقن يومية، وفريق هلا كير جعل الأمر سهلاً علينا. خدمة احترافية ومواعيد دقيقة.",
    ...
    },
    {
      ...
      rating: 5,
      text: "المتابعة المستمرة من فريق هلا كير ساعدتني في السيطرة على ضغط الدم. فريق محترف وودود.",
