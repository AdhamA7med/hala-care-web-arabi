  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "خدمة ممتازة جداً! الممرضة كانت محترفة ولطيفة مع والدي. شعرنا بالراحة والأمان. أنصح الجميع بحلا كير.",
    ...
    },
    {
      ...
      rating: 5,
      text: "فريق حلا كير ساعدني كثيراً في إدارة مرض السكري. الممرضة تأتي في الوقت المحدد وتتابع حالتي بعناية فائقة.",
    ...
    },
    {
      ...
      rating: 5,
      text: "بعد عمليتي الجراحية، كنت بحاجة لرعاية خاصة. فريق حلا كير قدم لي أفضل رعاية في منزلي. شكراً لكم.",
    ...
    },
    {
      ...
      rating: 5,
      text: "ابنتي كانت تحتاج حقن يومية، وفريق حلا كير جعل الأمر سهلاً علينا. خدمة احترافية ومواعيد دقيقة.",
    ...
    },
    {
      ...
      rating: 5,
      text: "المتابعة المستمرة من فريق حلا كير ساعدتني في السيطرة على ضغط الدم. فريق محترف وودود.",
