      ...
      <div className="container mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
             ترو كير هي شركة رائدة في مجال خدمات التمريض المنزلي، نسعى لتقديم رعاية طبية متميزة في راحة منازلكم
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              في مكتب ترو كير، نؤمن بأن كل شخص يستحق الحصول على رعاية طبية عالية الجودة في راحة منزله. نحن نجمع بين الخبرة الطبية المتخصصة والرعاية الإنسانية لنقدم خدمات تمريض منزلي تتجاوز توقعاتكم.
            </p>
            <p className="text-gray-600 leading-relaxed">
